...
import pandas as pd
import openpyxl
from backend.nonnegfac.nmf import NMF
nmf = NMF()


# Read Excel and output as NumPy array
wb = openpyxl.load_workbook('backend/testing/r.xlsx', read_only=True)
ws = wb.active
...
def main():
    ...
    np.savetxt('backend/r_filled.csv', filled, delimiter=',', fmt='%f')
